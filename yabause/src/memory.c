...
void MappedMemoryInit(SH2_struct *msh2, SH2_struct *ssh2)
{
   ...
   FillMemoryArea(sh2[i], 0x5A0, 0x5AF, &SoundRamReadByte,
                                ...
                                &SoundRamWriteWord,
                                &SoundRamWriteLong);
   FillMemoryArea(sh2[i], 0x5B0, 0x5BF, &scsp_r_b,
                                &scsp_r_w,
                                &scsp_r_d,
                                &scsp_w_b,
                                &scsp_w_w,
...
#endif
{
   switch (addr >> 29)
   {
      ...
      {
         // Cache/Non-Cached
         return ReadByteList[(addr >> 16) & 0xFFF](sh, addr);
      }
/*
      case 0x2:
      {
...
#endif
{
   switch (addr >> 29)
   {
      ...
      {
         // Cache/Non-Cached
         return ReadWordList[(addr >> 16) & 0xFFF](sh, addr);
      }
/*
      case 0x2:
      {
...
#endif
{
   switch (addr >> 29)
   {
      ...
      {
         // Cache/Non-Cached
         return ReadLongList[(addr >> 16) & 0xFFF](sh, addr);
      }
/*
      case 0x2:
      {
...
#endif
{
   ...
   switch (addr >> 29)
   {
      ...
      {
         // Cache/Non-Cached
         WriteByteList[(addr >> 16) & 0xFFF](sh, addr, val);
         return;
      }
/*
      case 0x2:
...
#endif
{
   switch (addr >> 29)
   {
      ...
      {
         // Cache/Non-Cached
         WriteWordList[(addr >> 16) & 0xFFF](sh,addr, val);
         return;
      }
/*
      case 0x2:
...
#endif
{
   switch (addr >> 29)
   {
      ...
      {
         // Cache/Non-Cached
         WriteLongList[(addr >> 16) & 0xFFF](sh, addr, val);
         return;
      }
      case 0x2:
      {
